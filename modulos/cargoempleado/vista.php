...
function setTablaCargos($datos = array()) {
    global $tablaAmpliciones;
    global $titulo;
    ...
    foreach ($datos as $registro) {
        $tablaAmpliciones .= '<tr>';
        $tablaAmpliciones .= '<td>' . $registro['idCargo'] . '</td>';
        $tablaAmpliciones .= '<td>';
        if ($registro['estado'] == 'Eliminado') { 
                $tablaAmpliciones .= '<a href="javascript:verDetalle(' . $registro['idCargo'] . ')" title="VER DETALLE DE ESTE CARGO"><i class="fa fa-eye"></i></a>';
        }else if ($registro['estado'] == 'Registrado') {
                $tablaAmpliciones .= '&nbsp;&nbsp;<a href="javascript:verActualizar(' . $registro['idCargo'] . ')" title="VER ACTUALIZAR DE ESTE CORPORATIVO"><i class="fa fa-edit"></i></a>';
                $tablaAmpliciones .= '&nbsp;&nbsp;<a href="javascript:verEliminar(' . $registro['idCargo'] . ')" title="VER ELIMINAR DE ESTOS CORPORATIVOS"><i class="fa fa-times"></i></a>';
            }
            $tablaAmpliciones .= '</td>';
            $tablaAmpliciones .= '<td>' . $registro['cargo'] . '</td>';
            ...
            $tablaAmpliciones .= '<td>' . $registro['fechahoramod'] . '</td>';
            $tablaAmpliciones .= '</tr>';
        }
        $titulo = 'LISTADO DE CARGOS DE EMPLEADO';
    }
