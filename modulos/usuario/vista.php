...
function setTablaUsuarios($datos = array()) {
    ...
    foreach ($datos as $registro) {
        ...
        $tablaAmpliciones .= '</td>';
        $tablaAmpliciones .= '<td>' . strtoupper($registro['usuario']) . '</td>';
        $tablaAmpliciones .= '<td>' . strtoupper($registro['login']) . '</td>';
        if ($registro['estado']=='Eliminado'){
        $tablaAmpliciones .= '<td style="color:red">' .strtoupper($registro['estado']) . '</td>';
        }else if ($registro['estado']=='Activo'){
           $tablaAmpliciones .= '<td style="color:green">' .strtoupper($registro['estado']) . '</td>'; 
        }       
